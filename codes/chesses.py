...
def help(st):
    if st == 'letters':
        print('    Первая буква озночает цвет фигуры: w - Белая')
        print('                                       b - Черная')
        print('    Вторая буква озночает тип фигуры:  Q - Ферзь')
        print('                                       B - Слон')
        print('                                       N - Конь')
        print('                                       R - Ладья')
        print('                                       P - Пешка')
        ...
        print('    Rook (R):    Ладья')
        print('    Как ходит:   По горизонтали или по вертикиали')
        print('    Ограничения: Не может ходить сквозь другие фигуры')
        print('    Пример:      ----x---')
        print('                 ----x---')
        print('                 ----x---')
        print('                 xxxxRxxx')
        ...
        print('    Queen (Q):   Ферзь')
        print('    Как ходит:   По диагонали, горизонтали или вертикали')
        print('    Ограничения: Не может ходить сквозь другие фигуры')
        print('    Пример:      -x--x--x')
        print('                 --x-x-x-')
        print('                 ---xxx--')
        ...
        print('    Knight (N):  Конь')
        print('    Как ходит:   Буквой "Г" - 2 клетки в 1 сторону, затем 1 в другую')
        print('    Ограничения: Нет')
        print('    Пример:      --------')
        print('                 ---x-x--')
        print('                 --x---x-')
        print('                 ----N---')
        ...
        print('    Pawn (P):    Пешка')
        print('    Как ходит:   На 1 клетку вперед, при первом ходу может пойти на 2 клетки')
        print('                 Бьет по диагонлаи на 1 клетку вперед, есть "взятие на проходе"')
        print('    Ограничения: Не ходит сквозь другие клетки')
        print('    Пример:      --------')
        print('                 --------')
        print('                 ----x+x-')
        print('                 -----P--')
        ...
        print('    King (K):    Король')
        print('    Как ходит:   На 1 клетку в любую сторону, также возможна "рокировка"')
        print('    Ограничения: Не может ходить под шах (аналогично для рокировки)')
        print('                 Также нельзя оставлять короля под шахом после своего хода')
        print('    Пример:      --------')
        print('                 --------')
        print('                 ----xxx-')
        print('                 ----xKx-')
